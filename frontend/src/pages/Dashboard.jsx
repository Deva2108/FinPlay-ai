...
export default function Dashboard() {
  ...
  useEffect(() => {
    console.log("DEBUG: Dashboard (Arena) mounted");
    console.log(`DEBUG: Market Mode: ${marketMode}, Balance: ${balance}`);
  }, [marketMode, balance]);
  ...
  const activeData = marketMode === "INDIA" ? indiaData : usData;
  ...
  return (
    ...
    <MarketInsightPanel 
      ...
      onTryGame={(index) => {
        console.log("Game should start with:", index);
        setGameContext(index);
      }}
    />
    <div className={`transition-colors duration-500 min-h-full w-full pb-20 ${marketTone}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8 space-y-6">
